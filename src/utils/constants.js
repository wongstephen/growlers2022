export const services = {
  ...
  playPark: {
    title: "Play Park",
    description: `Experience the ultimate haven for your canine companions at our pet paradise park, where tail-wagging fun meets convenience! We are thrilled to unveil our latest addition — a state-of-the-art dog self-wash station! Now, you can indulge your pup in an exhilarating run under the open sky and follow it up with a refreshing and easy self-service wash. Your four-legged friend will be sparkling clean and ready for a cozy ride back home.
